(function($) {
  ...
  ml.strip_tags = function(input, allowed) {
    ...
    input = ml.replaceAll('&nbsp;', ' ', input);
    input = ml.replaceAll('&quot;', '"', input);
    input = ml.replaceAll('&ldquo;', '“', input);
    input = ml.replaceAll('&rdquo;', '”', input);
    input = ml.replaceAll("&#39;", "'", input);
  ...
  ml.truncate_html = function(text, limit) {
    ...
    // We do want that the space characters to count as 1, not 6...
    text = ml.replaceAll('&nbsp;', ' ', text);
    text = ml.replaceAll('&quot;', '"', text);
    text = ml.replaceAll('&ldquo;', '“', text);
    text = ml.replaceAll('&rdquo;', '”', text);
    text = ml.replaceAll("&#39;", "'", text);
  ...
  ml.replaceAll = function(find, replace, str) {
